...
const MAHI_PRODUCTS = [
  ...
  {id:'p2',  badge:'HOT',  bc:'hot',  cat:'electronics', name:'Samsung Galaxy S25 — 12GB/256GB Galaxy AI',         price:129999, old:149999, stars:5, rev:1200,  img:'images/Samsung-Galaxy-S25-Icyblue.jpg',  e:'📱', bg:'#0d1a2a', sec:'flash'},
  {id:'p3',  badge:'NEW',  bc:'new',  cat:'electronics', name:'Apple Watch Series 10 — 46mm GPS + Cellular',       price:68999,  old:79999,  stars:4, rev:867,   img:'images/Apple-Watch-Series-10---Aluminum-Jet-Black-2186.jpg',  e:'⌚', bg:'#1a1a1a', sec:'flash'},
  {id:'p4',  badge:'-15%', bc:'',     cat:'electronics', name:'Sony WH-1000XM5 Noise Cancelling Headphones',       price:28499,  old:33499,  stars:5, rev:2300,  img:'images/Sony-WH-1000XM5-Wireless-Headphone-Black.webp',  e:'🎧', bg:'#111',    sec:'flash'},
  {id:'p5',  badge:'NEW',  bc:'new',  cat:'electronics', name:'Apple iPad Pro M4 — 11" 256GB Wi-Fi + Cellular',    price:119999, old:129999, stars:5, rev:654,   img:'images/ipad-pro-13-inch-m4-space-black-01-500x500.webp',  e:'📱', bg:'#1a1a2a', sec:'flash'},
  {id:'p6',  badge:'-10%', bc:'',     cat:'electronics', name:'Apple MacBook Air M3 — 13" 8GB/256GB Midnight',     price:149999, old:165999, stars:5, rev:932,   img:'images/MacBook-Air-M3-Chip.jpg',  e:'💻', bg:'#111',    sec:'trending'},
  {id:'p7',  badge:'HOT',  bc:'hot',  cat:'gaming',      name:'PS5 DualSense Wireless Controller — White',          price:8499,   old:10999,  stars:5, rev:1400,  img:'images/PlayStation-5-DualSens-Controller-(1).png',  e:'🎮', bg:'#0d0d1a', sec:'trending'},
  {id:'p8',  badge:'NEW',  bc:'new',  cat:'fashion',     name:"Nike Air Max 270 — Men's Running Shoes",             price:12499,  old:15999,  stars:4, rev:3100,  img:'images/NIKE-AH6789100-WHIWHI-NIKE-AIR-MAX-270-color-white-black-white_6_74909ddf-8675-4816-8a85-f6a963249320.webp',  e:'👟', bg:'#0a0a12', sec:'trending'},
  {id:'p9',  badge:'-25%', bc:'',     cat:'electronics', name:'JBL Flip 6 Portable Waterproof Speaker',             price:9499,   old:12599,  stars:5, rev:4700,  img:'images/JBL_Flip_6_2.webp',  e:'🔊', bg:'#1a0a00', sec:'trending'},
  {id:'p10', badge:'',     bc:'',     cat:'gaming',      name:'Logitech G502 X Plus Wireless Gaming Mouse',         price:11999,  old:14499,  stars:5, rev:2800,  img:'images/logitech-g502-x-plus-lightspeed-wireless-gaming-mouse_1.jpg',  e:'🖱️', bg:'#0a1200', sec:'trending'},
  {id:'p11', badge:'-30%', bc:'',     cat:'home',        name:'Dyson V15 Detect Absolute Cordless Vacuum',          price:69999,  old:99999,  stars:5, rev:1900,  img:'images/Dyson v15.webp',  e:'🧹', bg:'#1a1000', sec:'home'},
  {id:'p12', badge:'NEW',  bc:'new',  cat:'home',        name:'Philips Essential Air Fryer 4.1L — Digital',         price:8999,   old:11499,  stars:4, rev:3400,  img:'images/philips-essential-air-fryer-5-19-2024.jpg',  e:'🍳', bg:'#111',    sec:'home'},
  {id:'p13', badge:'',     bc:'',     cat:'home',        name:'Nespresso Vertuo Next Coffee Machine — Black',        price:18499,  old:22999,  stars:5, rev:2100,  img:'images/nespresso coffeee machine.jpg',  e:'☕', bg:'#1a0a00', sec:'home'},
  {id:'p14', badge:'-20%', bc:'',     cat:'electronics', name:'Garmin Fenix 7 Solar — Multisport GPS Watch',        price:74999,  old:89999,  stars:5, rev:876,   img:'images/garrmin fenix-7-sapphire-solar-gray-cf-lg.webp',  e:'⌚', bg:'#1a1a1a', sec:'home'},
  {id:'p15', badge:'SALE', bc:'hot',  cat:'electronics', name:'Kindle Paperwhite 11th Gen — 16GB Waterproof',      price:12999,  old:16499,  stars:5, rev:5200,  img:'images/Kindle Paperwhite 11th Gen (2)-1000x1000w.jpg.webp',  e:'📖', bg:'#111',    sec:'home'},
  {id:'p16', badge:'NEW',  bc:'new',  cat:'fashion',     name:"Levi's 501 Original Fit Jeans — Stonewash Blue",     price:4999,   old:6499,   stars:4, rev:6200,  img:'images/levis jeans.jpg',  e:'👖', bg:'#0a0a1a', sec:'fashion'},
  {id:'p17', badge:'-35%', bc:'',     cat:'fashion',     name:'Ray-Ban Aviator Classic — Gold Frame G-15',          price:8999,   old:13999,  stars:5, rev:4800,  img:'images/ray-ban-aviator.webp',  e:'🕶️', bg:'#1a1000', sec:'fashion'},
  {id:'p18', badge:'',     bc:'',     cat:'fashion',     name:'Premium Leather Messenger Bag — 15" Laptop',         price:5499,   old:7999,   stars:5, rev:1300,  img:'images/Premium Leather Bag.webp',  e:'👜', bg:'#1a0a00', sec:'fashion'},
  {id:'p19', badge:'HOT',  bc:'hot',  cat:'fashion',     name:'Adidas Essentials Fleece Hoodie — Unisex Black',     price:3299,   old:4499,   stars:4, rev:7100,  img:'images/Adidas Essential Fleece Hoodie.jpg',  e:'👕', bg:'#111',    sec:'fashion'},
  {id:'p20', badge:'-20%', bc:'',     cat:'beauty',      name:'Dior Sauvage Eau de Parfum — 100ml',                 price:14999,  old:18499,  stars:5, rev:9300,  img:'images/Dior-Sauvage-EDP-for-Men-100ml.png',  e:'🧴', bg:'#0d0d1a', sec:'fashion'},
  {id:'p21', badge:'NEW',  bc:'new',  cat:'sports',      name:'Lululemon The Mat 5mm — Non-Slip Yoga Mat',          price:5299,   old:6999,   stars:5, rev:4100,  img:'images/Lululemon The Mat.jpg',  e:'🧘', bg:'#0a1a0a', sec:'sports'},
  {id:'p22', badge:'-18%', bc:'',     cat:'sports',      name:'Bowflex Adjustable Dumbbell Set — 5-52.5 lbs',       price:34999,  old:42499,  stars:4, rev:2600,  img:'images/Bowflex Dumble set.avif',  e:'🏋️', bg:'#1a1a1a', sec:'sports'},
  {id:'p23', badge:'HOT',  bc:'hot',  cat:'sports',      name:"Adidas Ultraboost 23 — Women's Running Shoes",       price:16499,  old:19999,  stars:5, rev:5800,  img:'images/Adidas Ultraboost 23.jpg',  e:'👟', bg:'#0a0a1a', sec:'sports'},
  {id:'p24', badge:'',     bc:'',     cat:'sports',      name:'Giro Aether MIPS Helmet — Road Cycling',             price:12999,  old:15499,  stars:5, rev:1100,  img:'images/giro-aether helmet.webp',  e:'🪖', bg:'#111',    sec:'sports'},
  {id:'p25', badge:'-15%', bc:'',     cat:'sports',      name:'Hydro Flask 32oz Wide Mouth Insulated Bottle',       price:3999,   old:4699,   stars:5, rev:8900,  img:'images/Hydro Flask.jpg',  e:'🍶', bg:'#0a1a1a', sec:'sports'},
  {id:'p26', badge:'NEW',  bc:'new',  cat:'gaming',      name:'Mechanical Gaming Keyboard — RGB Backlit TKL',       price:7499,   old:9999,   stars:5, rev:1860,  img:'images/Mechanical Keyboard.webp',  e:'⌨️', bg:'#0a0a1a', sec:'trending'},
  {id:'p27', badge:'HOT',  bc:'hot',  cat:'gaming',      name:'Gaming Monitor 27" 165Hz QHD — IPS Panel',          price:32999,  old:39999,  stars:4, rev:982,   img:'images/Gaming Monitor.jpg',  e:'🖥️', bg:'#111',    sec:'trending'},
  {id:'p28', badge:'NEW',  bc:'new',  cat:'beauty',      name:'Korean Skincare Set — 7-Step Glow Routine',         price:5999,   old:8499,   stars:5, rev:3200,  img:'images/Korean-Skin-Care set.webp',  e:'✨', bg:'#1a0a1a', sec:'fashion'},
  {id:'p29', badge:'-25%', bc:'',     cat:'beauty',      name:'Professional Hair Dryer — Ionic 2400W',              price:6499,   old:8699,   stars:4, rev:2100,  img:'images/Hair Dryer.jpg',  e:'💨', bg:'#0d0a1a', sec:'fashion'},
  {id:'p30', badge:'POPULAR',bc:'hot',cat:'books',       name:'Atomic Habits — James Clear (Hardcover)',            price:1299,   old:1799,   stars:5, rev:12400, img:'images/atomic-habits.webp',  e:'📚', bg:'#0a0a0a', sec:'trending'},
  {id:'p31', badge:'NEW',  bc:'new',  cat:'books',       name:'The Psychology of Money — Morgan Housel',           price:999,    old:1399,   stars:5, rev:8700,  img:'images/The Psycology of Money.jpg',  e:'💰', bg:'#0d0a00', sec:'trending'},
  {id:'p32', badge:'FRESH', bc:'new', cat:'groceries',   name:'Organic Mixed Nuts — 1kg Premium Selection',        price:1899,   old:2499,   stars:4, rev:890,   img:'images/Organic Mixed Nuts.jpg',  e:'🥜', bg:'#1a1000', sec:'trending'},
  {id:'p33', badge:'',     bc:'',     cat:'groceries',   name:'Premium Green Tea — Organic Darjeeling 250g',       price:899,    old:1199,   stars:5, rev:2340,  img:'images/Organic Green Tea.jpg',  e:'🍵', bg:'#0a1a0a', sec:'trending'},
  ...
  {id:'p35', badge:'-22%', bc:'',     cat:'electronics', name:'Xiaomi 14 Ultra — Leica Camera Flagship 512GB',     price:139999, old:179999, stars:5, rev:445,   img:'images/Xiaomi 14 ultra.png',  e:'📱', bg:'#111',    sec:'flash'},
  {id:'p36', badge:'NEW',  bc:'new',  cat:'home',        name:'Instant Pot Duo 7-in-1 Electric Pressure Cooker',   price:12499,  old:15999,  stars:4, rev:7600,  img:'images/insrtant dot duo 7 in 1.jpg',  e:'🍲', bg:'#1a0a00', sec:'home'},
  {id:'p37', badge:'-40%', bc:'hot',  cat:'fashion',     name:'Uniqlo Ultra-Light Down Jacket — Men & Women',      price:4499,   old:7499,   stars:5, rev:3900,  img:'images/Uniqlo ultra light down jacket.avif',  e:'🧥', bg:'#0d0a1a', sec:'fashion'},
  ...
  {id:'p39', badge:'-28%', bc:'',     cat:'gaming',      name:'Nintendo Switch OLED — White / Neon Set',           price:44999,  old:62999,  stars:5, rev:3200,  img:'images/Nintendo switch Oled.jpg',  e:'🎮', bg:'#0d0d0d', sec:'flash'},
  {id:'p40', badge:'HOT',  bc:'hot',  cat:'beauty',      name:'Olaplex No.3 Hair Perfector — Full Treatment Kit',  price:7999,   old:10499,  stars:5, rev:5400,  img:'images/Olaplex Hair Perfector.jpg',  e:'💆', bg:'#1a0a1a', sec:'fashion'},
];
